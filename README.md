...
```bibtex
@unpublished{Hossen_electrode_design,
  title  = {Loading-Constrained Inverse Design of Fast-Charging Lithium-Ion
            Electrodes via Physics-Validated Machine Learning},
