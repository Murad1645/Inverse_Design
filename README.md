# Loading-Constrained Inverse Design of Fast-Charging Lithium-Ion Electrodes via Physics-Validated Machine Learning

This repository contains the complete dataset and code to reproduce the results of the paper:

> **Loading-Constrained Inverse Design of Fast-Charging Lithium-Ion Electrodes via Physics-Validated Machine Learning**
> Md. Murad Hossen
> Department of Materials Science and Engineering, Rajshahi University of Engineering and Technology (RUET), Rajshahi, Bangladesh
> Corresponding author: 2013028@student.ruet.ac.bd
> _Associated manuscript._
...
```bash
# 1. Surrogate accuracy (Section 3.1)             → R² ≈ 0.99 (Q_ratio), 0.91 (ΔV₃C)
...
At matched areal loading, the optimized electrode improves 3C rate capability by ≈1.4× and reduces polarization by ≈30%. The surrogate reproduces the full-physics prediction within ≈0.7% for rate capability and ≈4% for polarization.
...
Md. Murad Hossen, _Loading-Constrained Inverse Design of Fast-Charging
Lithium-Ion Electrodes via Physics-Validated Machine Learning_,
submitted to the _Journal of Energy Storage_.

```

This work relies on **PyBaMM**; please also cite Sulzer et al. (2021), _Journal of Open Research Software_ 9(1):14, and the Chen2020 parameter set (Chen et al., 2020, _J. Electrochem. Soc._ 167:080534).
